...
//begin experiment trials
  ...
  [
    ...
    [
      { stimulus: 'sound/fafa.wav',imageLeft:'img/bouba_7_L.png',imageRight:"img/kiki_7_L.png"},
      { stimulus: 'sound/zaza.wav',imageRight:'img/bouba_7_L_R.png',imageLeft:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/kiki.wav',imageLeft:'img/bouba_7_S.png',imageRight:"img/kiki_7_S.png"},
      { stimulus: 'sound/sasa.wav',imageRight:'img/bouba_7_L.png',imageLeft:"img/kiki_7_L.png"},
  
      { stimulus: 'sound/fifi.wav',imageLeft:'img/bouba_7_S_R.png',imageRight:"img/kiki_7_S_R.png"},
      { stimulus: 'sound/didi.wav',imageLeft:'img/bouba_7_L_R.png',imageRight:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/kaka.wav',imageRight:'img/bouba_7_L_R.png',imageLeft:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/sisi.wav',imageRight:'img/bouba_7_S_R.png',imageLeft:"img/kiki_7_S_R.png"},
  
      { stimulus: 'sound/mama.wav',imageLeft:'img/bouba_7_L_R.png',imageRight:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/tata.wav',imageLeft:'img/bouba_7_S_R.png',imageRight:"img/kiki_7_S_R.png"},
      { stimulus: 'sound/mimi.wav',imageLeft:'img/bouba_7_S_R.png',imageRight:"img/kiki_7_S_R.png"},
      { stimulus: 'sound/dada.wav',imageRight:'img/bouba_7_S.png',imageLeft:"img/kiki_7_S.png"},
  
      { stimulus: 'sound/zizi.wav',imageRight:'img/bouba_7_L.png',imageLeft:"img/kiki_7_L.png"},
      { stimulus: 'sound/lala.wav',imageLeft:'img/bouba_7_L.png',imageRight:"img/kiki_7_L.png"},
      { stimulus: 'sound/titi.wav',imageRight:'img/bouba_7_S.png',imageLeft:"img/kiki_7_S.png"},
      { stimulus: 'sound/lili.wav',imageRight:'img/bouba_7_S.png',imageLeft:"img/kiki_7_S.png"},
  
  
      { stimulus: 'sound/fafa.wav',imageRight:'img/bouba_7_L.png',imageLeft:"img/kiki_7_L.png"},
      { stimulus: 'sound/zaza.wav',imageLeft:'img/bouba_7_L_R.png',imageRight:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/kiki.wav',imageRight:'img/bouba_7_S.png',imageLeft:"img/kiki_7_S.png"},
      { stimulus: 'sound/sasa.wav',imageLeft:'img/bouba_7_L.png',imageRight:"img/kiki_7_L.png"},
  
      { stimulus: 'sound/fifi.wav',imageRight:'img/bouba_7_S_R.png',imageLeft:"img/kiki_7_S_R.png"},
      { stimulus: 'sound/didi.wav',imageRight:'img/bouba_7_L_R.png',imageLeft:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/kaka.wav',imageLeft:'img/bouba_7_L_R.png',imageRight:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/sisi.wav',imageLeft:'img/bouba_7_S_R.png',imageRight:"img/kiki_7_S_R.png"},
  
      { stimulus: 'sound/mama.wav',imageRight:'img/bouba_7_L_R.png',imageLeft:"img/kiki_7_L_R.png"},
      { stimulus: 'sound/tata.wav',imageRight:'img/bouba_7_S_R.png',imageLeft:"img/kiki_7_S_R.png"},
      { stimulus: 'sound/mimi.wav',imageRight:'img/bouba_7_S_R.png',imageLeft:"img/kiki_7_S_R.png"},
      { stimulus: 'sound/dada.wav',imageLeft:'img/bouba_7_S.png',imageRight:"img/kiki_7_S.png"},
  
      { stimulus: 'sound/zizi.wav',imageLeft:'img/bouba_7_L.png',imageRight:"img/kiki_7_L.png"},
      { stimulus: 'sound/lala.wav',imageRight:'img/bouba_7_L.png',imageLeft:"img/kiki_7_L.png"},
      { stimulus: 'sound/titi.wav',imageLeft:'img/bouba_7_S.png',imageRight:"img/kiki_7_S.png"},
      { stimulus: 'sound/lili.wav',imageLeft:'img/bouba_7_S.png',imageRight:"img/kiki_7_S.png"},
    ],
